...
The last 7 days of observations in the [Acartia.io](https://acartia.io) data cooperative by [Peter Ince](https://github.com/peterdouglas).  | The last month of daily traffic in the [Orcasound web app](live.orcasound.net) by [Adrian MacDonald](linkedin.com/in/adrian-macdonald). 
